...
const AsignarHoras = () => {
  ...
  useEffect(() => {
    const obtenerEstudiantes = async () => {
      try {
        const res = await axios.get('http://192.168.1.14:3000/api/estudiantes/obtenerEstudiantes');
  ...
  const enviarAsistencia = async () => {
    ...
    try {
      await axios.post('http://192.168.1.14:3000/api/asistencia/agregarAsistencia', {
