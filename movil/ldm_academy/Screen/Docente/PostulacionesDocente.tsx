  ...
  useEffect(() => {
    const obtenerPostulaciones = async () => {
      try {
        ...
        const response = await axios.get(`http://192.168.1.14:3000/api/postulacion/mostrarPostulacionesPorDocente/${idDocente}`);
      ...
      Alert.alert(
        ...
        [
          ...
          },
          {
            text: 'Aceptar',
            onPress: async () => {
              const response = await axios.put(`http://192.168.1.14:3000/api/postulacion/aceptarPostulacion/${idPostulacion}`, { correo });
      ...
      Alert.alert(
        ...
        [
          ...
          },
          {
            text: 'Rechazar',
            onPress: async () => {
              const response = await axios.put(`http://192.168.1.14:3000/api/postulacion/rechazarPostulacion/${idPostulacion}`, { correo });
              if (response.status === 200) {
