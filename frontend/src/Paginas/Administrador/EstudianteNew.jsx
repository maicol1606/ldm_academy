  ...
  return (
    <div className="bg-estudiante">
      <div className="container py-5 animate-fadeInUp">
        <NavegacionAdmin />
        <div className="card shadow-lg border-0 rounded-4 p-4 mx-auto bg-light" style={{ maxWidth: "900px" }}>
          ...
          <form autoComplete="off" onSubmit={handleSubmit}>
            <div className="row g-4">
              <div className="col-md-6">
                ...
                <input type="text" name="nombre" pattern="^[A-Za-zÁ-ÿÑñ\s]+$" maxLength="27"
                  className="form-control rounded-pill" onChange={handleChange}
                  placeholder="Ingrese el nombre" required />
              </div>
              <div className="col-md-6">
                <label className="form-label fw-bold text-primary">Apellido</label>
                <input type="text" name="apellido" pattern="^[A-Za-zÁ-ÿÑñ\s]+$" maxLength="40"
                  className="form-control rounded-pill" onChange={handleChange}
                  placeholder="Ingrese el apellido" required />
              </div>
              <div className="col-md-6">
                <label className="form-label fw-bold text-primary">Curso</label>
                <select name="curso" className="form-select rounded-pill" onChange={handleChange} required>
              ...
              <div className="col-md-6">
                ...
                <input type="email" name="correo"
                  ...
                  className="form-control rounded-pill" maxLength="40"
              ...
              <div className="col-md-6">
  <label className="form-label fw-bold text-primary">Confirmar Contraseña</label>
  <input
    type="password"
    ...
    required
  />
  {user.confirmarContrasena && user.confirmarContrasena !== user.contrasena && (
