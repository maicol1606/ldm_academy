                ...
                >
                    <div className="content text-start" style={{ flex: 1, marginRight: "20px" }}>
                        ...
                        <p className="text-black">
                            ...
                            formación retribuir a la sociedad, contribuyendo con propuestas de
                            solución y aplicación de conocimientos integrales hacia los sectores más
                            desfavorecidos.
                        </p>
                    ...
                    <div className="modal-overlay position-fixed top-0 start-0 w-100 h-100 bg-dark bg-opacity-50 d-flex justify-content-center align-items-center">
                        ...
                        >
                            ...
                            <p className="text-muted text-center">
                                Completar las <strong>120 horas</strong> de servicio social es
                                obligatorio y te brinda la oportunidad de contribuir al bienestar de
                                tu comunidad mientras desarrollas habilidades clave para tu
                                formación.
                            </p>
